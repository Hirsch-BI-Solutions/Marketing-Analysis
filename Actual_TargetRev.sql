...
-- calculate (target-actual)/Target_revenue*100
...
select Marketing_Channel,Month,Date,(Target_Revenue - Actual_Revenue)/Target_Revenue*100 as Revenue_as_Percentage
from joined_table
